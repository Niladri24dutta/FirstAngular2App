...
var ProductFilterPipe = (function () {
    ...
    ProductFilterPipe.prototype.transform = function (values, args) {
        var filter = args ? args.toLocaleLowerCase() : null;
        return filter ? values.filter(function (product) { return product.productName.toLocaleLowerCase().indexOf(filter) != -1; }) : values;
    };
